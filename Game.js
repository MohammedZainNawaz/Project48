...
//adding the striker2
  ...
  play(){
    ...
    background(0)
     ...
     text("first player score = "+score1,100,100)
...
if(flag===0){
 ...
 //movement of striker2


 /*if(mousePressedOver(striker2)&&striker2.x<780 && striker2.y>=120){
  striker2.velocityX=20;
  striker2.velocityY=-40;
  flag=2
}else if(mousePressedOver(striker2)&&striker2.x>780 && striker2.y>=120){
  striker2.velocityX=-20;
  striker2.velocityY=-18;
  flag=2
}else*/ if(keyDown("s")){
  striker2.velocityY=20;
  flag=1;
}
...
//............................................
  ...
  if(wcoin1.isTouching(hole)&& flag===0){
    wcoin1.destroy();
    striker1.x = 786
    striker1.y = 597
    striker1.friction = 1
  ...
  if(wcoin2.isTouching(hole) && flag===0){
    wcoin2.destroy();
    striker1.x = 786
    striker1.y = 597
    striker1.friction = 1
  ...
  if(wcoin3.isTouching(hole) && flag===0){
    wcoin3.destroy();
    striker1.x = 786
    striker1.y = 597
    striker1.friction = 1
  ...
  if(wcoin4.isTouching(hole)  && flag===0){
    wcoin4.destroy();
    striker1.x = 786
    striker1.y = 597
    striker1.friction = 1
  ...
  if(wcoin5.isTouching(hole) && flag===0){
    wcoin5.destroy();
    striker1.x = 786
    striker1.y = 597
    striker1.friction = 1
  ...
  if(wcoin6.isTouching(hole) && flag===0){
    wcoin6.destroy();
    striker1.x = 786
    striker1.y = 597
    striker1.friction = 1
  ...
  if(wcoin7.isTouching(hole) && flag===0){
    wcoin7.destroy();
    striker1.x = 786
    striker1.y = 597
    striker1.friction = 1
  ...
  if(wcoin8.isTouching(hole) && flag===0){
    wcoin8.destroy();
    striker1.x = 786
    striker1.y = 597
    striker1.friction = 1
  ...
  if(wcoin9.isTouching(hole) && flag===0){
    wcoin9.destroy();
    striker1.x = 786
    striker1.y = 597
    striker1.friction = 1
  ...
  //...............................
  if(wcoin1.isTouching(hole2) && flag===0){
    wcoin9.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 20
  ...
  if(wcoin2.isTouching(hole2)&& flag===0){
    wcoin2.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 20
  }
  if(wcoin3.isTouching(hole2)&& flag===0){
    wcoin3.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 20
  }
  if(wcoin4.isTouching(hole2)&& flag===0){
    wcoin4.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 20
  }
  if(wcoin5.isTouching(hole2)&& flag===0){
    wcoin5.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 20
  }
  if(wcoin6.isTouching(hole2)&& flag===0){
    wcoin6.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 20
  }
  if(wcoin7.isTouching(hole2)&& flag===0){
    wcoin7.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 20
  }
  if(wcoin8.isTouching(hole2)&& flag===0){
    wcoin8.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 20
  }
  if(wcoin9.isTouching(hole2)&& flag===0){
    wcoin9.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 20
...
//..................................
  if(wcoin1.isTouching(hole3)&& flag===0){
    wcoin1.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 20
  ...
  if(wcoin2.isTouching(hole3)&& flag===0){
    wcoin2.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 20
  }
  if(wcoin3.isTouching(hole3)&& flag===0){
    wcoin3.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 20
  }
  if(wcoin4.isTouching(hole3)&& flag===0){
    wcoin4.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 20
  }
  if(wcoin5.isTouching(hole3)&& flag===0){
    wcoin5.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 20
  }
  if(wcoin6.isTouching(hole3)&& flag===0){
    wcoin6.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 20
  }
  if(wcoin7.isTouching(hole3)&& flag===0){
    wcoin7.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 20
  ...
  if(wcoin8.isTouching(hole3)&& flag===0){
    wcoin8.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 20
  }
  if(wcoin9.isTouching(hole3)&& flag===0){
    wcoin9.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 20
...
//.................................
if(wcoin1.isTouching(hole4)&& flag===0){
  wcoin1.destroy();
  striker1.x = 786
  striker1.y = 597
  score1 += 20
...
if(wcoin2.isTouching(hole4) && flag===0){
  wcoin2.destroy();
  striker1.x = 786
  striker1.y = 597
  score1 += 20
}
if(wcoin3.isTouching(hole4) && flag===0){
  wcoin3.destroy();
  striker1.x = 786
  striker1.y = 597
  score1 += 20
}
if(wcoin4.isTouching(hole4)  && flag===0){
  wcoin4.destroy();
  striker1.x = 786
  striker1.y = 597
  score1 += 20
}
if(wcoin5.isTouching(hole4) && flag===0){
  wcoin5.destroy();
  striker1.x = 786
  striker1.y = 597
  score1 += 20
}
if(wcoin6.isTouching(hole4) && flag===0){
  wcoin6.destroy();
  striker1.x = 786
  striker1.y = 597
  score1 += 20
}
if(wcoin7.isTouching(hole4) && flag===0){
  wcoin7.destroy();
  striker1.x = 786
  striker1.y = 597
  score1 += 20
}
if(wcoin8.isTouching(hole4) && flag===0){
  wcoin8.destroy();
  striker1.x = 786
  striker1.y = 597
  score1 += 20
}
if(wcoin9.isTouching(hole4) && flag===0){
  wcoin9.destroy();
  striker1.x = 786
  striker1.y = 597
  score1 += 20
  ...
  if(bcoin1.isTouching(hole)&& flag===0){
    bcoin1.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 10
  ...
  if(bcoin2.isTouching(hole) && flag===0){
    bcoin2.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 10
  }
  if(bcoin3.isTouching(hole) && flag===0){
    bcoin3.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 10
  }
  if(bcoin4.isTouching(hole)  && flag===0){
    bcoin4.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 10
  }
  if(bcoin5.isTouching(hole) && flag===0){
    bcoin5.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 10
  }
  if(bcoin6.isTouching(hole) && flag===0){
    bcoin6.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 10
  }
  if(bcoin7.isTouching(hole) && flag===0){
    bcoin7.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 10
  }
  if(bcoin8.isTouching(hole) && flag===0){
    bcoin8.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 10
  }
  if(bcoin9.isTouching(hole) && flag===0){
    bcoin9.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 10
  ...
  //...............................
  if(bcoin1.isTouching(hole2) && flag===0){
    bcoin9.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 10
  ...
  if(bcoin2.isTouching(hole2)&& flag===0){
    bcoin2.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 10
  }
  if(bcoin3.isTouching(hole2)&& flag===0){
    bcoin3.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 10
  }
  if(bcoin4.isTouching(hole2)&& flag===0){
    bcoin4.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 10
  }
  if(bcoin5.isTouching(hole2)&& flag===0){
    bcoin5.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 10
  }
  if(bcoin6.isTouching(hole2)&& flag===0){
    bcoin6.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 10
  }
  if(bcoin7.isTouching(hole2)&& flag===0){
    bcoin7.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 10
  }
  if(bcoin8.isTouching(hole2)&& flag===0){
    bcoin8.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 10
  }
  if(bcoin9.isTouching(hole2)&& flag===0){
    bcoin9.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 10
...
//..................................
  if(bcoin1.isTouching(hole3)&& flag===0){
    bcoin1.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 10
  ...
  if(bcoin2.isTouching(hole3)&& flag===0){
    bcoin2.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 10
  }
  if(bcoin3.isTouching(hole3)&& flag===0){
    bcoin3.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 10
  }
  if(bcoin4.isTouching(hole3)&& flag===0){
    bcoin4.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 10
  }
  if(bcoin5.isTouching(hole3)&& flag===0){
    bcoin5.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 10
  }
  if(bcoin6.isTouching(hole3)&& flag===0){
    bcoin6.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 10
  }
  if(bcoin7.isTouching(hole3)&& flag===0){
    bcoin7.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 10
  }
  if(bcoin8.isTouching(hole3)&& flag===0){
    bcoin8.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 10
  }
  if(bcoin9.isTouching(hole3)&& flag===0){
    bcoin9.destroy();
    striker1.x = 786
    striker1.y = 597
    score1 += 10
...
//.................................
if(bcoin1.isTouching(hole4)&& flag===0){
  bcoin1.destroy();
  striker1.x = 786
  striker1.y = 597
  score1 += 10
...
if(bcoin2.isTouching(hole4) && flag===0){
  bcoin2.destroy();
  striker1.x = 786
  striker1.y = 597
  score1 += 10
...
if(bcoin3.isTouching(hole4) && flag===0){
  bcoin3.destroy();
  striker1.x = 786
  striker1.y = 597
  score1 += 10
}
if(bcoin4.isTouching(hole4)  && flag===0){
  bcoin4.destroy();
  striker1.x = 786
  striker1.y = 597
  score1 += 10
}
if(bcoin5.isTouching(hole4) && flag===0){
  bcoin5.destroy();
  striker1.x = 786
  striker1.y = 597
  score1 += 10
}
if(bcoin6.isTouching(hole4) && flag===0){
  bcoin6.destroy();
  striker1.x = 786
  striker1.y = 597
  score1 += 10
}
if(bcoin7.isTouching(hole4) && flag===0){
  bcoin7.destroy();
  striker1.x = 786
  striker1.y = 597
  score1 += 10
}
if(bcoin8.isTouching(hole4) && flag===0){
  bcoin8.destroy();
  striker1.x = 786
  striker1.y = 597
  score1 += 10
}
if(bcoin9.isTouching(hole4) && flag===0){
  bcoin9.destroy();
  striker1.x = 786
  striker1.y = 597
  score1 += 10
  ...
  //rcoin
  if(rcoin.isTouching(hole) && flag===0){
    rcoin.destroy();
    striker1.x = 786
    striker1.y = 597
  }
  if(rcoin.isTouching(hole2) && flag===0){
    rcoin.destroy();
    striker1.x = 786
    striker1.y = 597
  }
  if(rcoin.isTouching(hole3) && flag===0){
    rcoin.destroy();
    striker1.x = 786
    striker1.y = 597
  }
  if(rcoin.isTouching(hole4) && flag===0){
    rcoin.destroy();
    striker1.x = 786
    striker1.y = 597
  }
 ...
 fill('red')
 text("RULES",170,375)
 text("Striker 1 can strike by pressing UP arrow",10,400)
 text("Striker 2 can strike by pressing S Button",10,425)
// text("If you pot the red coin you may get 50 points",10,450)
 //text("ALL THE BEST try to score 160 points to win",10,475)
